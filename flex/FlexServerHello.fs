...
/// <summary>
    /// Selects the first cipher suite offered by the client that is supported by the server.
    /// </summary>
    /// <param name="client">Client cipher suites</param>
    /// <param name="server">Server-supported cipher suites</param>
    /// <returns>First mutually supported cipher suite, if any</returns>
